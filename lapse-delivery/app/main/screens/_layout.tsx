  ...
  if (width < 76) {
    return (
      <View>
        ...
        {Platform.OS === "ios" ? (
          <StyledButton title="Download on the App Store" variant="primary" onPress={() => Linking} />
        ) : (
          <StyledButton title="Download on the Play Store" variant="primary" onPress={() => Linking} />
        )}
      </View>
    );
  }
